...
extern bool of_EVENT_DEFER_BEGIN(vthread_t thr, vvp_code_t code);
extern bool of_EVENT_DEFER_END(vthread_t thr, vvp_code_t code);
...
extern bool of_JMP_WAIT(vthread_t thr, vvp_code_t code);
...
extern bool of_ASSIGNI_VEC4(vthread_t thr, vvp_code_t code);
extern bool of_LOAD_FLAG(vthread_t thr, vvp_code_t code);
...
extern bool of_SHIFTLI(vthread_t thr, vvp_code_t code);
extern bool of_SHIFTR(vthread_t thr, vvp_code_t code);
extern bool of_SHIFTR_S(vthread_t thr, vvp_code_t code);
extern bool of_SHIFTRI(vthread_t thr, vvp_code_t code);
extern bool of_SHIFTRI_S(vthread_t thr, vvp_code_t code);
...
extern bool of_STORE_VEC4_EVENT(vthread_t thr, vvp_code_t code);
extern bool of_STORE_VEC4_FULL(vthread_t thr, vvp_code_t code);
extern bool of_STORE_VEC4_FULL_EVENT(vthread_t thr, vvp_code_t code);
