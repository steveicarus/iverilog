...
static const struct opcode_table_s opcode_table[] = {
      ...
      { "%event/defer/begin", of_EVENT_DEFER_BEGIN, 0, {OA_NONE, OA_NONE, OA_NONE} },
      { "%event/defer/end",   of_EVENT_DEFER_END,   0, {OA_NONE, OA_NONE, OA_NONE} },
      ...
      { "%shiftli",  of_SHIFTLI,  1, {OA_NUMBER, OA_NONE,   OA_NONE} },
      { "%shiftr",   of_SHIFTR,   1, {OA_NUMBER, OA_NONE,   OA_NONE} },
      { "%shiftr/s", of_SHIFTR_S, 1, {OA_NUMBER, OA_NONE,   OA_NONE} },
      { "%shiftri",  of_SHIFTRI,  1, {OA_NUMBER, OA_NONE,   OA_NONE} },
      { "%shiftri/s",of_SHIFTRI_S,1, {OA_NUMBER, OA_NONE,   OA_NONE} },
      ...
      { "%store/vec4/event",of_STORE_VEC4_EVENT,3,{OA_FUNC_PTR,OA_BIT1,OA_BIT2} },
