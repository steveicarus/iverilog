...
class SequentialStmt  : public LineInfo {
    ...
    public:
      virtual int elaborate(Entity*ent, ScopeBase*arc);
      virtual int emit(ostream&out, Entity*entity, ScopeBase*arc);
...
class LoopStatement : public SequentialStmt {
    ...
    protected:
      int elaborate_substatements(Entity*ent, ScopeBase*arc);
      int emit_substatements(std::ostream&out, Entity*ent, ScopeBase*arc);
...
class IfSequential  : public SequentialStmt {
    ...
    public:
	  ...
	  public:
	    ...
	    int elaborate(Entity*entity, ScopeBase*arc);
	    int condition_emit(ostream&out, Entity*entity, ScopeBase*arc);
	    int statement_emit(ostream&out, Entity*entity, ScopeBase*arc);
    ...
    public:
      int elaborate(Entity*ent, ScopeBase*arc);
      int emit(ostream&out, Entity*entity, ScopeBase*arc);
      void dump(ostream&out, int indent) const;
      void visit(SeqStmtVisitor& func);
...
class CaseSeqStmt : public SequentialStmt {
    public:
      class CaseStmtAlternative : public LineInfo {
	    ...
	    int elaborate_expr(Entity*ent, ScopeBase*arc, const VType*ltype);
	    int elaborate(Entity*ent, ScopeBase*arc);
	    int emit(ostream&out, Entity*entity, ScopeBase*arc);
	    void visit(SeqStmtVisitor& func);
...
class ForLoopStatement : public LoopStatement {
    ...
    private:
      ...
      int emit_runtime_(ostream&out, Entity*ent, ScopeBase*arc);
